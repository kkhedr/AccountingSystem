    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-th"></i><span>@lang('site.dashboard')</span></a></li>
                ...
                <li><a href="{{ route('dashboard.unit.create') }}"><i class="fa fa-th"></i><span>@lang('site.unitadd')</span></a></li>
            <li><a href="{{ route('dashboard.unit.index') }}"><i class="fa fa-th"></i><span>@lang('site.indexunit')</span></a></li>

            <li><a href="{{ route('dashboard.type.create') }}"><i class="fa fa-th"></i><span>@lang('site.categoryadd')</span></a></li>

            <li><a href="{{ route('dashboard.type.index') }}"><i class="fa fa-th"></i><span>@lang('site.categoryindex')</span></a></li>


            <li><a href="{{ route('dashboard.products.create') }}"><i class="fa fa-th"></i><span>@lang('site.Productadd')</span></a></li>
